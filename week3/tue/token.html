...
<body class="body">
    <div class="wrapper">
        <div class="sidebar">
            ...
            <div class="signout">
                <span class="">
                    <a href="sign-in.html" class="signout-link">
                    ...
                    <div class="content-area">
                        <div class="right-sidebar-settings">
                            ...
                            <div class="sidebar-guide">
                                ...
                                <a href="security.html""><span class="guide-text ">Security</span></a>
                            </div>
                            <div class="sidebar-guide">
                            ...
                            <div class="sidebar-guide">
                                ...
                                <a href="token.html"><span class="guide-text bold">Get Token</span></a>
                            </div>
                        </div>
                        <div class="grid-area-settings">
                            <div class="grid--area-wrapper">
                                <div class="settings-heading">
                                    <div class="card-heading author-title">Get Token</div>
                                    <div class="card-heading author-title blur">Add token to begin tracking</div>
                                </div>
                                <div class="settings-form">
                                    
                                    <div class="card-heading author-title normal">Copy this code and paste it on the header section of your website</div>
                                    <div class="token-group">
                                        <div class="card-heading author-title normal">KGFHKJDHFH8377643987!@#$#$JHBCB4</div>
                                        <button>Copy</button>
                                    </div>
                                </div>
                            </div>
